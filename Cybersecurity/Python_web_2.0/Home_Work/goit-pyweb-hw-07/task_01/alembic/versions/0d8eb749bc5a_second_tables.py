...
Revision ID: 0d8eb749bc5a
Revises: 
Create Date: 2026-03-21 07:39:46.143508
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_grades_date_received'), 'grades', ['date_received'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_grades_date_received'), table_name='grades')
